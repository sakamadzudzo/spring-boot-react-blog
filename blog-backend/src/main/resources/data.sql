...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'sakamadzudzo', now()-1, 'sakamadzudzo', now()-1);
 ...
 , '1', 'sakamadzudzo', now()-2, 'sakamadzudzo', now()-2);
...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'sakamadzudzo', now()-3, 'sakamadzudzo', now()-3);
...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'sakamadzudzo', now()-4, 'sakamadzudzo', now()-4);
...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'sakamadzudzo', now()-5, 'sakamadzudzo', now()-5);
